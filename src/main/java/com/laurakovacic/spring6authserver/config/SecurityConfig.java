package com.laurakovacic.spring6authserver.config;
...
public class SecurityConfig {
    ...
    // so when the resource server gets JWT token, it can call back to the auth server, get the public key and validate
    //  that the token has a valid payload (data)
    @Bean
